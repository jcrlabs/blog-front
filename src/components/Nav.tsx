      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        ...
        >
          ...
          <span className="font-semibold text-[15px] tracking-tight text-[var(--text)] group-hover:text-white transition-colors">
            AI<span style={{ color: "var(--accent)" }}>·</span>feed
          </span>
        </Link>
        ...
        <div className="flex items-center gap-1" role="list">
          <div role="listitem">
            <Link
              ...
              className="flex items-center gap-1.5 text-xs text-[var(--text-3)] hover:text-[var(--accent)] transition-colors px-3 py-2 rounded-lg hover:bg-[var(--surface)] min-h-[38px]"
            >
          ...
          <div role="listitem">
            <a
              ...
              className="flex items-center gap-1.5 text-xs text-[var(--text-3)] hover:text-[var(--text-2)] transition-colors px-3 py-2 rounded-lg hover:bg-[var(--surface)] min-h-[38px]"
            >
